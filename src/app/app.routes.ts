    ...
    children: [
...

      {
        ...
        children: [
          ...
          {
            path: 'consulta-juicios-mercantiles',
            loadComponent: () =>
              import('./features/juicios/consulta-juicios-mercantiles/consulta-juicios-mercantiles')
                .then(m => m.ConsultaJuiciosMercantiles),
            data: { breadcrumb: 'Consulta juicios mercantiles' }
          }
        ]
      },
